...
//		
//		Account acc1 = new Account (30000,"CA");
...
//		org.hibernate.Query query = ses.createQuery// hibernate
...
//		query.list().forEach(t->System.out.println(t));
		...
		Query query = ses.getNamedQuery("Tx.findAllByCityAmountGreaterThan");
	//	ses.createQuery
		
		
		//Query query = ses.createQuery//persistant query
...
//		ses.persist(new Employee("Abc",Date.of(1947, 8 ,15),20000,'M',false));
