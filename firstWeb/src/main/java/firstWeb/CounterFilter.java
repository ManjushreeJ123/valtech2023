...
//		Map<String,Integer> counters = (Map<String,Integer>) application.getAttribute ("counter");
//				//request.getServletContext().getAttribute("counters");
//		HttpServletRequest req = (HttpServletRequest)request;
//		String uri = req.getRequestURI();
//	//	counters.put(uri, countersKey(uri)? counters.get(uri + 1 : 1);
