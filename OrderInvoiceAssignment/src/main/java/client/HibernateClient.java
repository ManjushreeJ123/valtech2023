...
//		Customer cus = new Customer("Manjushree", 21);
// 		ses.save(cus);
...
//		ses.persist(new Employee("Anna", df.parse("15-08-1947"), 2000, 'F', false));
//		
...
//		
//		Customer cus1 = new Customer("Takie", 25);
//		Address add1 = new Address("Jayanagar","Blr", 560056);
//		Customer cus2 = new Customer("Jaya", 72);
//		Address add2 = new Address("Rajiv Nagar","Hyd", 540050);
//		
//		ses.persist(acc);
//		ses.persist(tx1);
//		ses.persist(tx2);
...
//		sesFac.close();
		...
		Customers cus1 = new Customers("Manjushree","7259445672","manjuj@gmail.com");
		CustomerAddress custAdd1 = new CustomerAddress("jp nagar","Bangalore","Karnataka",560066);
		Customers cus2 = new Customers("Teju","62728374464","tejuj@gmail.com");
		CustomerAddress custAdd2 = new CustomerAddress("jayanagar","Bangalore","karnataka",560013);
		...
		VendorAddress vendorAdd2 = new VendorAddress("MG Road","Tumkur","Karanataka",120012);
		vendor1.setVendorAddress(vendorAdd1 );
